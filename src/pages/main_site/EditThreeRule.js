...
class EditThreeRule extends Component{
    ...
    componentDidMount() {
        ...
        fetch("http://localhost:3299/list_of_things/"+this.props.match.params.id).then(response=>response.json()).then((rule_json) =>
    ...
    handleSubmit(event) {
        ...
        fetch("http://localhost:3299/list_of_things/"+ rule.id ,{
            "body": jsonified_rule,
            "headers":{
